        ...
        <div className="flex flex-wrap gap-2 justify-center mb-6">
          {tabs.map((tab, idx) => (
            <button
              ...
              className={`px-4 py-2 rounded-full font-medium transition-colors border border-border shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/50 ${selected === idx ? "bg-primary text-primary-foreground" : "bg-background text-foreground hover:bg-accent"}`}
            >
              {tab.name}
            </button>
          ))}
